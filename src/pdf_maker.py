...
parser.add_argument("-title", metavar="title", nargs="+", type=str, default="Plots", help="title of the generated pdf")
...
os.chdir("tex_generated/")
os.system("pdflatex generated_template.tex")

os.system(f"cp generated_template.pdf {path}")
